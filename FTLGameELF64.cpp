...
{
	static void *func = 0;
	static FunctionDefinition funcObj("ShipObject::RemoveEquipment", typeid(void (ShipObject::*)(const std::string &, bool )), ".415741564155415455534889fb4883ec??488d??2430", nullptr, 0, 0, &func);
}

void ShipObject::RemoveEquipment(const std::string &blueprint, bool completely)
{
	typedef void (*custom_arg_funcptr_t)(ShipObject *this_arg, const std::string &blueprint_arg, bool completely_arg);
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("ShipObject::AddEquipment", typeid(void (ShipObject::*)(const std::string &)), ".415741564155415455534889fb4883ec", nullptr, 0, 0, &func);
}

void ShipObject::AddEquipment(const std::string &blueprint)
{
	typedef void (*custom_arg_funcptr_t)(ShipObject *this_arg, const std::string &blueprint_arg);
